...
<body>
	<div class="wrapper">
		...
		<main>
			...
			<table  class="table table-sm table-bordered">
				<tr>
					...
					<td>
						<?php
							if($check['join'] == 'done'){
								print $eventDetail['title'] . " " . '<span class="badge text-bg-success">参加</span>';
							}else{
				...
				<tr>
					<th>開始日時</th>
					<td><?php print  date("Y/m/d H:i" , strtotime($eventDetail['start'])); ?></td>
				</tr>
				<tr>
					<th>終了日時</th>
					<td><?php print $eventDetail['end'] == "0000-00-00 00:00:00" ? "未定" : date("Y/m/d H:i" , strtotime($eventDetail['end'])); ?></td>
				</tr>
				<tr>
					<th>場所</th>
					<td><?php print $eventDetail['place']; ?></td>
				</tr>
				<tr>
					<th>対象グループ</th>
					<td>
				...
				<tr>
					<th>詳細</th>
					<td><?php print $eventDetail['detail']; ?></td>
				</tr>
				<tr>
					<th>登録者</th>
					<td>
			...
			<a class="btn btn-secondary" role="button" href="detail_event.php?view=<?php print $eventId; ?>&page=<?php print $page; ?>">キャンセル</a>

			<?php if($registUser['id'] == $_SESSION['user_id'] || $_SESSION['user_type_id'] == '2'): ?>
				<a class="btn btn-danger" role="button" href="delete_event_do.php?view=<?php print $eventId; ?>">削除する</a>
			<?php endif; ?>
